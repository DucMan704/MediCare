...
import { daysVi, translateExperience, translateSpeciality } from "../utils/i18n";
...
const Appointment = () => {
  ...
  const getAvailableSolts = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      if (today.getDate() === currentDate.getDate() && today.getHours() >= 21) {
        continue;
      }
        ...
        <div className="flex gap-3 items-center w-full overflow-x-scroll mt-4">
          {docSlots.length &&
            docSlots.map((item, index) => (
              ...
              >
                <p>{item[0] && daysVi[item[0].datetime.getDay()]}</p>
